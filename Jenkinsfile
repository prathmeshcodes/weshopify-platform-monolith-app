        ...
        stage('copying the docker and jfrog files to ansible'){
            steps{
                ...
                sshagent(['Ansible-Machine']){
                    sh 'scp jfrog-server-conn.sh ansible-admin@192.168.0.131:/home/ansbile-admin/ci-cd-files'
                    sh 'scp Dockerfile ansible-admin@192.168.0.131:/home/ansbile-admin/ci-cd-files'
